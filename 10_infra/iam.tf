...
resource "aws_iam_instance_profile" "app_ec2_profile" {
  name = aws_iam_role.new_app_iam_role.name
  role = aws_iam_role.new_app_iam_role.name
}

resource "aws_iam_role" "new_app_iam_role" {
...
resource "aws_iam_role_policy_attachment" "new_app_iam_role_ec2_readonly" {
  role       = aws_iam_role.new_app_iam_role.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonEC2ReadOnlyAccess"
}

resource "aws_iam_role_policy_attachment" "new_app_iam_role_ssm_managed" {
  role       = aws_iam_role.new_app_iam_role.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonSSMManagedInstanceCore"
}

resource "aws_iam_role_policy_attachment" "new_app_iam_role_ssm_readonly" {
  role       = aws_iam_role.new_app_iam_role.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonSSMReadOnlyAccess"
}

resource "aws_iam_role_policy_attachment" "new_app_iam_role_s3_readonly" {
  role       = aws_iam_role.new_app_iam_role.name
